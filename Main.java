...
public class Main {
	...
	public static Student[] creatStudentsArray(Group<Student> gr) {
	...
	public static void main(String[] args) {
		Group<Student> gr = new Group<Student>("ST-91");
...
//		gr.sortByLastName(); // sort by lastname
		gr.sortByParameter(0, 1); // Sorted by: (0 - name, 1 - lastname, 2 - surename, 3 - by age)// (1 - ascending, -1 descending)
		System.out.println(gr);
		Voenkom v = gr; // 
	...
	public static void fillingArray(Student student, Group<Student> g) {
		try {
	...
	public static void fillingArray(Student[] array, Group<Student> g) {
